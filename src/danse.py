...
from rnn import RNN_model, push_model, save_model
...
class DANSE(nn.Module):
    ...
    def __init__(self, n_states, n_obs, mu_w, C_w, H, mu_x0, C_x0, rnn_params_dict):
        ...
        self.rnn = RNN_model(**rnn_params_dict)
...
def evaluate_danse(options, test_loader, device, model_file=None, usenorm_flag=0, test_logfile_path = None):
